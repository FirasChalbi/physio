...
export default function GlassPage() {
  const dockIcons = [
    { src: "https://raw.githubusercontent.com/lucasromerodb/liquid-glass-effect-macos/refs/heads/main/assets/finder.png",   alt: "Finder"   },
    { src: "https://raw.githubusercontent.com/lucasromerodb/liquid-glass-effect-macos/refs/heads/main/assets/map.png",      alt: "Map"      },
    { src: "https://raw.githubusercontent.com/lucasromerodb/liquid-glass-effect-macos/refs/heads/main/assets/messages.png", alt: "Messages" },
    { src: "https://raw.githubusercontent.com/lucasromerodb/liquid-glass-effect-macos/refs/heads/main/assets/notes.png",    alt: "Notes"    },
    { src: "https://raw.githubusercontent.com/lucasromerodb/liquid-glass-effect-macos/refs/heads/main/assets/safari.png",   alt: "Safari"   },
    { src: "https://raw.githubusercontent.com/lucasromerodb/liquid-glass-effect-macos/refs/heads/main/assets/books.png",    alt: "Books"    },
  ];
  ...
  return (
    <>
      <style>{`
        ...
        /* Menu */
        .menu-wrap:hover { padding: 0.6rem; }
        .menu-item:hover {
        ...
        /* Dock */
        .dock-wrap:hover { padding: 0.8rem; border-radius: 2.5rem; }
        /* Button */
        .btn-wrap:hover { padding: 1.8rem 2.8rem; border-radius: 4rem; }
        .btn-wrap:hover .btn-inner { border-radius: 4rem; }
        .btn-wrap:hover svg { transform: scale(0.95); }
      ...
      {/* ── Page ── */}
      <div className="bg-animated min-h-screen flex flex-col items-center justify-center gap-6 font-sans">

        {/* 1 · Search button */}
        <button className="relative flex items-center rounded-2xl overflow-hidden cursor-pointer shadow-[0_6px_6px_rgba(0,0,0,0.2),0_0_20px_rgba(0,0,0,0.1)] glass-transition hover:scale-105 active:scale-95">
          <div className="glass-filter-layer absolute inset-0 rounded-[inherit] z-0" />
          <div className="absolute inset-0 rounded-[inherit] bg-white/25 z-10" />
          <div className="absolute inset-0 rounded-[inherit] z-20 shadow-[inset_1px_1px_0_rgba(255,255,255,0.75),inset_0_0_5px_rgba(255,255,255,0.75)]" />
          <div className="relative z-30 flex items-center gap-2 px-7 py-3 text-white text-sm font-medium">
            <svg viewBox="0 0 512 512" width="22" className="fill-white shrink-0">
        ...
        {/* 2 · Menu */}
        <div className="menu-wrap relative flex overflow-hidden cursor-pointer font-semibold rounded-[1.8rem] p-[0.4rem] shadow-[0_6px_6px_rgba(0,0,0,0.2),0_0_20px_rgba(0,0,0,0.1)] glass-transition">
          <div className="liquid-effect absolute inset-0 z-0 rounded-[inherit] overflow-hidden" />
          <div className="absolute inset-0 z-10 rounded-[inherit] bg-white/25" />
          <div className="absolute inset-0 z-20 rounded-[inherit] shadow-[inset_2px_2px_1px_0_rgba(255,255,255,0.5),inset_-1px_-1px_1px_1px_rgba(255,255,255,0.5)]" />
          <div className="relative z-30">
            {["New file", "Open file", "Settings", "Repository"].map((item) => (
              <div key={item} className="menu-item text-white text-xl px-[0.6rem] py-[0.4rem] rounded-[0.8rem] transition-all duration-100 select-none">
                {item}
              </div>
            ))}
          </div>
        ...
        {/* 3 · Dock */}
        <div className="dock-wrap relative flex overflow-hidden cursor-pointer rounded-[2rem] p-[0.6rem] shadow-[0_6px_6px_rgba(0,0,0,0.2),0_0_20px_rgba(0,0,0,0.1)] glass-transition">
          <div className="liquid-effect absolute inset-0 z-0 rounded-[inherit] overflow-hidden" />
          <div className="absolute inset-0 z-10 rounded-[inherit] bg-white/25" />
          <div className="absolute inset-0 z-20 rounded-[inherit] shadow-[inset_2px_2px_1px_0_rgba(255,255,255,0.5),inset_-1px_-1px_1px_1px_rgba(255,255,255,0.5)]" />
          <div className="relative z-30 flex items-center justify-center gap-2 p-[0.6rem] rounded-[2rem]">
            {dockIcons.map((icon) => (
              <img key={icon.alt} src={icon.src} alt={icon.alt} className="w-[75px] glass-transition hover:scale-95" />
            ))}
          </div>
        </div>
