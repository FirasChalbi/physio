            ...
            <div className="w-full max-w-md relative z-10">
                ...
                <div className="rounded-2xl border p-6 md:p-8" style={{ background: '#12121a', borderColor: 'rgba(255,255,255,0.06)' }}>
                    ...
                    <div className="grid grid-cols-2 gap-3">
                        <button onClick={() => signIn("google", { callbackUrl: "/account" })} className="flex items-center justify-center gap-2 py-3 rounded-xl text-sm font-medium text-[#a0a0b8] hover:text-white border transition-colors hover:bg-white/[0.03]" style={{ borderColor: 'rgba(255,255,255,0.08)' }}>
                        ...
                        <button onClick={() => signIn("facebook", { callbackUrl: "/account" })} className="flex items-center justify-center gap-2 py-3 rounded-xl text-sm font-medium text-[#a0a0b8] hover:text-white border transition-colors hover:bg-white/[0.03]" style={{ borderColor: 'rgba(255,255,255,0.08)' }}>
